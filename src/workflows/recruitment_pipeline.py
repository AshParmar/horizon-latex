...
def try_linkedin_enrichment_node(state: RecruitmentState) -> RecruitmentState:
    ...
    try:
        ...
        json_file = f"enhanced_candidates_{timestamp}.json"
...
def visualize_pipeline(pipeline, save_path: str = "recruitment_pipeline_graph.png"):
    """
...
def run_complete_pipeline(
    ...
    visualize_pipeline(pipeline, save_path="recruitment_pipeline_graph.png")
